...
namespace GameTracker.Frontend.Helpers
{
    public static class LinqHelper
    {
        ...
        public static Func<IGrouping<string, Game>, bool> PublisherFilter(string? filter) => g => string.IsNullOrEmpty(filter) ? true : g.Any(g2 => g2.Publisher?.ToLower().Contains(filter.ToLower()) ?? false);
        ...
        public static Func<IGrouping<string, Game>, bool> StudioFilter(string? filter) => g => string.IsNullOrEmpty(filter) ? true : g.Any(g2 => g2.Studio?.ToLower().Contains(filter.ToLower()) ?? false);
        ...
        public static Func<IGrouping<string, Game>, bool> PlatformFilter(PlatformsEnum filter) => g => filter == PlatformsEnum.None ? true : g.Any(g2 => g2.Platforms.HasFlag(filter));
        ...
        public static Func<IGrouping<string, Game>, string> PublisherSelector => g => g.FirstOrDefault(g2 => !string.IsNullOrEmpty(g2.Publisher))?.Publisher;
        ...
        public static Func<IGrouping<string, Game>, string> StudioSelector => g => g.FirstOrDefault(g2 => !string.IsNullOrEmpty(g2.Studio))?.Studio;
