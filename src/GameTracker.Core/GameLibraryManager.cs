...
namespace GameTracker.Core
{
    public class GameLibraryManager : IGameLibraryManager
    {
        ...
        private readonly IGameProviderFactory _providerFactory;
        private readonly Dictionary<Guid, IEnumerable<Game>> _providerGameDictionary;

        public GameLibraryManager(IParameterCacheRepository parameterCacheRepository, IGameProviderFactory providerFactory)
        {
